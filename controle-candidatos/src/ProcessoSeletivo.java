...
public class ProcessoSeletivo {
    public static void main(String[] args) {
        String[] candidatos = {"Carolina", "Janaina", "Hana", "Adriana", "Lilian"};
    ...
    static void selecaoCandidatos() {
        String[] candidatos = {"Carolina", "Janaina", "Hana", "Adriana", "Lilian", "Ranieri", "Freddy", "Tic", "Laryssa", "Raiany"};
        ...
        while (candidatosSelecionados < 5 && candidatosAtual < candidatos.length) {
            ...
            if (salarioBase >= salarioPretendido) {
                ...
                System.out.println("Que pena, tente novamente na próxima");
            }
            candidatosAtual++;
        }
    }
...
public class ProcessoSeletivo {
    ...
    static void analisarCandidato(){
        ...
        System.out.println("\n"+"Bem vinda ao nosso processo seletivo!"+"\n");

        System.out.println("Digite a pretenção salarial do candidato: ");
        double salarioCandidato = scanner.nextDouble();
 ...
 */
/*
//VERSÃO DO PROFESSOR. Achei interessante colocar porque é uma forma de usar métodos e incluir os dados sem o Scann
